...
public class PhiTitleBar extends ViewGroup implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (tag instanceof PhiTitleBar.Action) {
            final PhiTitleBar.Action action = (PhiTitleBar.Action) tag;
            action.performAction(view);
        }
    }

    /**
     * Adds a list of {@link PhiTitleBar.Action}s.
     *
     * @param actionList the actions to add
     */
    public void addActions(PhiTitleBar.ActionList actionList) {
    ...
    /**
     * Adds a new {@link PhiTitleBar.Action}.
     *
     * @param action the action to add
     */
    public View addAction(PhiTitleBar.Action action) {
        final int index = mRightLayout.getChildCount();
        return addAction(action, index);
    }

    /**
     * Adds a new {@link PhiTitleBar.Action} at the specified index.
     *
     * @param action the action to add
     * @param index  the position at which to add the action
     */
    public View addAction(PhiTitleBar.Action action, int index) {
     ...
     */
    public void removeAction(PhiTitleBar.Action action) {
        int childCount = mRightLayout.getChildCount();
        for (int i = 0; i < childCount; i++) {
            View view = mRightLayout.getChildAt(i);
            if (view != null) {
                final Object tag = view.getTag();
                if (tag instanceof PhiTitleBar.Action && tag.equals(action)) {
    ...
    /**
     * Inflates a {@link View} with the given {@link PhiTitleBar.Action}.
     *
     * @param action the action to inflate
     * @return a view
     */
    private View inflateAction(PhiTitleBar.Action action) {
        View view = null;
    ...
    public View getViewByAction(PhiTitleBar.Action action) {
    ...
    /**
     * A {@link LinkedList} that holds a list of {@link PhiTitleBar.Action}s.
     */
    @SuppressWarnings("serial")
    public static class ActionList extends LinkedList<PhiTitleBar.Action> {
    }
    ...
    public static abstract class ImageAction implements PhiTitleBar.Action {
    ...
    public static abstract class TextAction implements PhiTitleBar.Action {

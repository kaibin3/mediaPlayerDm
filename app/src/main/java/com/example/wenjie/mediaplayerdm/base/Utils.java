...
/**
 * Created by wenhui02.liu on 2016/11/1.
 */
public class Utils {
    ...
    public static String secondToDate(long timeInMillis) {
        ...
        String format = month + "/" + calendar.get(Calendar.DATE);
        return format;
    }

    public static String secondToDateYear(long timeInMillis) {
        Date date = new Date(timeInMillis);
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        int month = calendar.get(calendar.MONTH) + 1;
        ...
        String format = calendar.get(Calendar.YEAR) + "/" + month + "/" + calendar.get(Calendar.DATE);
        return format;
    }
    ...
    public static String secondToDate2(long timeInMillis) {
        Date date = new Date(timeInMillis);
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        String format = (calendar.get(Calendar.MONTH) + 1) + "月" + calendar.get(Calendar.DATE) + "日";
        return format;
    }
    ...
    public static String[] daysToDate(java.util.Date date, int days, boolean year) {
        if (days < 0) {
            return new String[0];
        }
        ...
        for (int i = 0; i < days; i++) {
            if (year) {
                dates[i] = calendar.get(Calendar.YEAR) + "/" + (calendar.get(Calendar.MONTH) + 1) + "/" + calendar.get(Calendar.DATE);
            } else {
                dates[i] = (calendar.get(Calendar.MONTH) + 1) + "/" + calendar.get(Calendar.DATE);
            }
            Log.d(TAG, "daysToDate: " + dates[i]);
            calendar.add(Calendar.DATE, -1);
        }
        return dates;
    }

    public static String[] weeksToDate(java.util.Date endDate, int weeks, boolean year) {
        if (weeks < 0) {
            return new String[0];
        }
        String[] dates = new String[weeks];
        Calendar calendar = Calendar.getInstance();
        if (null == endDate) {
        ...
        for (int i = 0; i < weeks; i++) {
            ...
            String startWeek;
            if (year) {
                startWeek = calendar.get(Calendar.YEAR) + "/" + (calendar.get(Calendar.MONTH) + 1) + "/" + calendar.get(Calendar.DATE);
            } else {
                startWeek = (calendar.get(Calendar.MONTH) + 1) + "/" + calendar.get(Calendar.DATE);
            }
            sb.append(startWeek);
            calendar.set(Calendar.DAY_OF_WEEK, Calendar.SATURDAY);
            String endWeek;
            if (year) {
                endWeek = calendar.get(Calendar.YEAR) + "/" + (calendar.get(Calendar.MONTH) + 1) + "/" + calendar.get(Calendar.DATE);
            } else {
                endWeek = (calendar.get(Calendar.MONTH) + 1) + "/" + calendar.get(Calendar.DATE);
            }
    ...
    public static String[] MonthsToDate(int months) {
        if (months < 0) {
            return new String[0];
        }
        ...
        for (int i1 = 0; i1 < months; i1++) {
            ...
            dates[months - i1 - 1] = i + 1 + "月";
        }
        return dates;
    }

    public static int secondToMonth(long date) {
